...
//            TODO these values are not bound right
            TimerDurationInput(label: "Work:", duration: $settingsManager.workTimerDuration)
                .padding(.bottom, 4)
            TimerDurationInput(label: "Short break:", duration: $settingsManager.restTimerDuration)
                .padding(.bottom, 4)
            TimerDurationInput(label: "Long break:", duration: $settingsManager.longRestTimerDuration)
